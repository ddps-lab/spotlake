...
BUCKET_FILE_PATH = os.environ.get('S3_PATH_PREFIX', 'rawdata/aws')

DATABASE_NAME = os.environ.get('DATABASE', 'spotlake')
AWS_TABLE_NAME = os.environ.get('DATABASE_TABLE', 'aws')

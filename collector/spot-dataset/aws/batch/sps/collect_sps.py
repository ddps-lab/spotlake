...
def main():
    ...
    WORKLOAD_BASE_PATH = os.environ.get("WORKLOAD_BASE_PATH", "rawdata/aws/workloads")
    SPS_BASE_PATH = os.environ.get("SPS_BASE_PATH", "rawdata/aws/sps")
    CREDENTIAL_FILE_PATH = os.environ.get("CREDENTIAL_FILE_PATH", "credential/credential_3699.csv")
    LOG_GROUP_NAME = os.environ.get("LOG_GROUP_NAME", "SPS-Server-Data-Count")
    LOG_STREAM_NAME = os.environ.get("LOG_STREAM_NAME", "aws")
    LOCAL_FILE_BASE_PATH = os.environ.get("LOCAL_FILE_BASE_PATH", "rawdata/aws/localfile")

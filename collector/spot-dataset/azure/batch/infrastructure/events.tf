...
resource "aws_iam_role" "scheduler_role" {
  name = "eventbridge_scheduler_role_spotlake_azure"
...
resource "aws_iam_policy" "scheduler_policy" {
  name        = "eventbridge_scheduler_policy_spotlake_azure"
  description = "Policy for EventBridge Scheduler to invoke Azure Batch Jobs"

class AzureCollector:
    def __init__(self):
        ...
        self.S3_LATEST_DESIRED_COUNT_1_DATA_AVAILABILITYZONE_TRUE_SAVE_PATH = "latest_data/latest_azure.json"
        self.S3_QUERY_SELECTOR_SAVE_PATH = "query-selector/azure/query_selector.json"

class Storage:
    def __init__(self):
        self.BUCKET_NAME = "spotlake"
        self.DATABASE_NAME = 'spotlake'
        self.TABLE_NAME = 'azure'

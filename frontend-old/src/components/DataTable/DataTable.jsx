...
const DataTable = ({ vendor, rowData, toolBar, setSelectedData }) => {
        ...
        "& .MuiDataGrid-main .Mui-checked, .MuiButton-textPrimary": {
          color:
            vendor === "AWS"
              ? "#f68d11 !important"
              : vendor === "GCP"
              ? "rgb(234, 67, 53) !important"
              : "#0067b8 !important",
        },
        "& .Mui-selected": {
          backgroundColor:
            vendor === "AWS"
              ? "rgba(246, 141, 17, 0.08) !important"
              : vendor === "GCP"
              ? "rgba(234, 67, 53, 0.08) !important"
              : "rgba(0, 103, 184, 0.08) !important",
        },
        "& .MuiDataGrid-cellCheckbox:focus-within": {
          outline:
            vendor === "AWS"
              ? "solid rgba(246, 141, 17, 0.5) 1px !important"
              : vendor === "GCP"
              ? "solid rgba(234, 67, 53, 0.5) 1px !important"
              : "solid rgba(0, 103, 184, 0.5) 1px !important",
        },
        "& .MuiDataGrid-cell": {
